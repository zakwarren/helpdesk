...
def start_tutored(player, manager):
    ...
    input(manager + ": I'll be with you every step of the way. ")
    ...
    input(manager + ": Let's take a look at your options. ")
    input(
    ...
    input(manager + ": This means they're more content to wait while you try to get it right. ")
...
def main():
    manager = "Jeff"
    player, start = setup_player(manager)
    if start == "tutored":
