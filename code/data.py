...
If not, write default files to disk
"""
import os
...
def default_disasters():
    """Write default disasters list to disk"""
    disasters = """{
    "password": [
        "locked the account",
        "deleted the account",
...
def default_issues():
    """Write default issues list to disk"""
    issues = """{
    "password": [
...
def default_names():
    """Write default names list to disk"""
    names = """[
    "Aaberg"
    ,
    "Aalst"
...
def default_options():
    """Write default options list to disk"""
    options = """{
    "password": [
